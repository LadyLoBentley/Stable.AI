...
class HorseSupplements(SQLModel, table=True):
    __tablename__ = "horse_supplements"

    # Primary keys
    horse_supplements_id: str = Field(default_factory=lambda: str(uuid.uuid4()), primary_key=True)
