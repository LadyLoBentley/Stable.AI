...
function FeedingRegimeTab() {
    ...
    useEffect(() => {
        ...
        setHeaderAction({
            label: regime ? "Edit Feeding Regime" : "Add Feeding Regime",
            onClick: () => setIsEditing(true)
        });

        return () => setHeaderAction(null);
    }, [error, isEditing, loading, regime, setHeaderAction]);
    ...
    if (loading) return <p className="pageMessage">Loading feeding regime information...</p>;
                ...
                <>
                    ...
                    <div className="formSection">
                        ...
                        {(() => {
                            ...
                            const active = reqs.filter((req) => req.on);
